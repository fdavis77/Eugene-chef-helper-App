...
const ICONS: Record<IconName, React.FC<React.SVGProps<SVGSVGElement>>> = {
    'chef-hat': (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M12 2C8.13 2 5 5.13 5 9c0 1.39.41 2.68 1.11 3.76-.43.3-.82.68-1.11 1.15V21h14v-7.09c-.29-.47-.68-.85-1.11-1.15C18.59 11.68 19 10.39 19 9c0-3.87-3.13-7-7-7z"/>
      </svg>
    ),
    carrot: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
        <path d="M14.5,2.1a1,1,0,0,0-1,0L10.7,4.3a1,1,0,1,0,1.6,1.2L14.5,3.5a1,1,0,0,0,0-1.4ZM9.3,5.7,7.1,3.5a1,1,0,0,0-1.6,1.2L7.7,6.9a1,1,0,0,0,1.6-1.2ZM19,10.86A5.33,5.33,0,0,0,13.72,6l-1.5,1.75-2.4-2.4a1,1,0,0,0-1.4,0,1,1,0,0,0,0,1.4L10.8,9,9.4,10.4a5.2,5.2,0,0,0-4.1,2.5A5.34,5.34,0,0,0,5,15.6a5.26,5.26,0,0,0,9.7,3.19A5.32,5.32,0,0,0,19,10.86Z"/>
      </svg>
    ),
    home: (props) => (
    ...
    flask: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 3.03v.568c0 .334.148.65.405.864l1.068.89c.442.369.535 1.01.216 1.49l-5.29 9.402a1.125 1.125 0 01-1.58.53l-1.06-.53a1.125 1.125 0 01-.53-1.58l5.29-9.402a1.125 1.125 0 011.49-.216l1.068.89a1.125 1.125 0 00.864-.405z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5c0-4.142 3.358-7.5 7.5-7.5s7.5 3.358 7.5 7.5z" />
      </svg>
    ),
    sparkles: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    quote: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 21v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.21-1.009-.584-1.372l-5.25-5.25a.75.75 0 00-1.06 0l-5.25 5.25c-.375.363-.584.856-.584 1.372v1.372A2.25 2.25 0 006 18.75h2.25m0 2.25H5.625c-.621 0-1.125-.504-1.125-1.125V18.75m12.75 0v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21m0 0h2.25a2.25 2.25 0 002.25-2.25v-1.372c0-.516-.21-1.009-.584-1.372l-5.25-5.25a.75.75 0 00-1.06 0l-5.25 5.25c-.375.363-.584.856-.584 1.372v1.372A2.25 2.25 0 0017.25 18.75h2.25m-15-3.75a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75h2.25a.75.75 0 00.75-.75V15a.75.75 0 00-.75-.75H5.25zm12 0a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75h2.25a.75.75 0 00.75-.75V15a.75.75 0 00-.75-.75h-2.25z" />
      </svg>
    ),
};
