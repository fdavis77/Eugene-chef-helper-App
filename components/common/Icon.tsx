...
const ICONS: Record<IconName, React.FC<React.SVGProps<SVGSVGElement>>> = {
    ...
    'clipboard-list': (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 5.25 6h.008a2.25 2.25 0 0 1 2.242 2.135 48.424 48.424 0 0 1-.1 3.465c-.215.613-.58 1.168-.995 1.621a2.25 2.25 0 0 0-.256 2.037c.21.358.55.656.954.814a2.25 2.25 0 0 0 2.323-.342c.376-.354.668-.799.865-1.281a48.421 48.421 0 0 0-.1-3.465Z" />
        </svg>
    ),
    copy: (props) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    flask: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M14.25 6.087c0-.66.537-1.197 1.197-1.197h.006c.66 0 1.197.537 1.197 1.197v7.625a3.375 3.375 0 0 1-3.375 3.375H10.5a3.375 3.375 0 0 1-3.375-3.375V6.087c0-.66.537-1.197 1.197-1.197h.006c.66 0 1.197.537 1.197 1.197M14.25 6.087a3.375 3.375 0 0 0-3.375-3.375H10.5a3.375 3.375 0 0 0-3.375 3.375m9.75 0a3.375 3.375 0 0 0-3.375-3.375H10.5a3.375 3.375 0 0 0-3.375 3.375M9 19.5v-2.25a3.375 3.375 0 0 1 3.375-3.375h1.5a3.375 3.375 0 0 1 3.375 3.375v2.25" />
      </svg>
    ),
    sparkles: (props) => (
      <svg {...props} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
